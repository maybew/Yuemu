...
public class NameMaker {
	...
	public static void generateName(){
		familyName = familyNames[random.nextInt(501)];
		if(random.nextBoolean() == true){
			sex = "MALE";
			firstName = boyNames[random.nextInt(136)];
		}                 
		else{
			sex = "FEMALE";
			firstName = girlNames[random.nextInt(158)];
		}
